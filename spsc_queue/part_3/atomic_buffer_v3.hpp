...
public:
    ...
    AtomicBuffer_V3(size_t capacity_)
    ...
    {
        std::size_t const currHead = head.load(std::memory_order_acquire);
    ...
    {
        std::size_t const currTail = tail.load(std::memory_order_acquire);
